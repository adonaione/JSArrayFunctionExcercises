...
// Define a function that converts inches to feet
function toFeet(inches) {
    return inches / 12;
}

// Use the map function to apply the toFeet function to each element in the array
let heightsInFeet = heightsInInches.map(toFeet);
...
// iterate through each dictionary to grab the values and print them in the appropriate format 
